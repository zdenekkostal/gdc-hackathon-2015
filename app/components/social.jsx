            ...
            <div id="social">
                ...
                <div className="row">
                    <div className="columns text-right">
                        Go to our <a href="https://plus.google.com/u/0/events/c97d89qhsb67hmi8jnmn3qoo6eg?authkey=CPavlrKlmbXVcw" target="_blank" className="color-pink">Google+ Event</a><br /> page to see more photos and videos from the hackathon.
                    </div>
                </div>
            </div>
        );
